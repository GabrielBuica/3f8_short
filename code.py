...
def fit_w(X_tilde_train, y_train, X_tilde_test, y_test, n_steps, alpha):
    ...
    for i in range(n_steps):
        ...
        w = w + alpha*np.dot(np.transpose(X_tilde_train), (y_train - sigmoid_value))# XXX Gradient-based update rule for w. To be completed by the student
...
alpha = 0.01# XXX Learning rate for gradient-based optimisation. To be completed by the student
